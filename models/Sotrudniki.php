...
class Sotrudniki extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_brigad', 'firstname', 'surname', 'date_birth', 'date_naim', 'passport',
                'phone_number', 'id_dolzhnosti'], 'required'],
            [['id_brigad', 'passport', 'id_dolzhnosti'], 'integer'],
            [['date_birth', 'date_naim'], 'safe'],
            [['firstname', 'surname'], 'string', 'max' => 255],
            [['phone_number'], 'string', 'max' => 15],
            [['id_dolzhnosti'], 'exist', 'skipOnError' => true, 'targetClass' =>
                Dolzhnosti::className(), 'targetAttribute' =>
                ['id_dolzhnosti' => 'id_dolzhnosti']],
            [['id_brigad'], 'exist', 'skipOnError' => true, 'targetClass' =>
                Brigades::className(), 'targetAttribute' => ['id_brigad' => 'id_brigad']],
        ];
    }
